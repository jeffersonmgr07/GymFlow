...
const GF_PLATFORM_HEADERS = Object.freeze({
  Tenants: ['tenant_id','name','slug','status','spreadsheet_id','theme_key','currency','locale','timezone','created_at','updated_at','version'],
  ...
  RolePermissions: ['role_permission_id','role_id','permission_id','created_at','version'],
...
const GF_TENANT_HEADERS = Object.freeze({
  ...
  Branches: ['branch_id','tenant_id','name','code','status','timezone','address_text','created_by','created_at','updated_by','updated_at','version'],
  Users: ['user_id','tenant_id','branch_id','email','display_name','public_name','status','avatar_url','created_by','created_at','updated_by','updated_at','version'],
